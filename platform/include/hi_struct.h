...
{
    HI_CHIP_TYPE_E  enChipTypeSoft;      /**< SDK软件对应的芯片类型 */
    HI_CHIP_TYPE_E  enChipTypeHardWare;  /**< SDK运行时检测到的芯片类型 */

    HI_CHAR         aVersion[64];        /**< SDK软件版本号字符串 */
}HI_SYS_VERSION_S;
...
{
    HI_CHAR bufname[MAX_BUFFER_NAME_SIZE];  /**< MMZ buffer名字字符串 */
    HI_U32  phyaddr;                /**< MMZ buffer物理地址 */
    HI_U8  *kernel_viraddr;         /**< MMZ buffer内核态虚拟地址 */
    HI_U8  *user_viraddr;           /**< MMZ buffer用户态虚拟地址 */
    HI_U32  bufsize;                /**< MMZ buffer大小 */
    HI_U32  overflow_threshold;     /**< MMZ buffer上溢水线，按百分比设置，例如: 100 indicates 100%.*/
    HI_U32  underflow_threshold;    /**< MMZ buffer下溢水线，按百分比设置，例如: 0 indicates 0%.*/
}HI_MMZ_BUF_S;
...
{
    HI_LAYER_ZORDER_MOVETOP = 0,  /**< 移到最顶部 */
    HI_LAYER_ZORDER_MOVEUP,       /**< 向上移到 */
    HI_LAYER_ZORDER_MOVEBOTTOM,   /**< 移到最底部 */
    HI_LAYER_ZORDER_MOVEDOWN,     /**< 向下移到 */
...
#define UMAP_DEV_NUM_TOTAL   	    UMAP_MAX_MINOR_OTP
