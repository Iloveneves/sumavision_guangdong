...
#define HA_AUDIO_ID_FFMPEG_DECODE   HA_BUILD_CODEC_ID(VENDOR_HISI,FORMAT_MULTI,HA_FFMPEG_ID)  /* support FORMAT_PCM/FORMAT_ADPCM/APE etc */
...
typedef enum
{
    HA_FFMPEG_EVENT_STATUS_CHANGE = 0,                   /**< 状态信息更新, 每帧更新一次     */
