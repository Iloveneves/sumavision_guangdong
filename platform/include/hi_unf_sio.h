...
#if  defined (CHIP_TYPE_hi3720v100) || defined (CHIP_TYPE_hi3720v101)
#define SIO_MAX_NUM 3
#elif  defined (CHIP_TYPE_hi3716cv100) || defined (CHIP_TYPE_hi3716cv101)
#define SIO_MAX_NUM 1
#elif  defined (CHIP_TYPE_hi3716hv100) || defined (CHIP_TYPE_hi3716hv101)
#define SIO_MAX_NUM 1
#elif  defined (CHIP_TYPE_hi3716mv100) || defined (CHIP_TYPE_hi3716mv101)
#define SIO_MAX_NUM 0
