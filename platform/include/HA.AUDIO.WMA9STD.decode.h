...
#define HA_AUDIO_ID_WMA9STD   HA_BUILD_CODEC_ID(VENDOR_NONE,FORMAT_MULTI,HA_WMA9STD_ID)  /**< support FORMAT_WMAV1,FORMAT_WMAV2 */
...
static HI_S32 HA_WMA_ParseCmp(FILE *pfcmp, WMA_FORMAT_S *pstWfx)
{
	...
	{
		printf("Support only CMP V1 format wFormatTag=0x%x!\n",pstWfx->wFormatTag);
		return -1;
	}
