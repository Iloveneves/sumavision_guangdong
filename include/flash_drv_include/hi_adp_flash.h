...
#define  HI_FLASH_RW_FLAG_RAW           0x0   /* general use */
#define  HI_FLASH_RW_FLAG_WITH_OOB      0x1   /* only use when write rootfs.yaffs */
#define  HI_FLASH_RW_FLAG_ERASE_FIRST   0x2   /* only use when write */
